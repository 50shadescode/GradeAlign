...
import { GraduationCap, Mail, MessageCircle, ShieldCheck, Globe, Users, ArrowRight } from 'lucide-react';
  ...
  return (
    <footer style={{ backgroundColor: '#1F2937', color: 'white', padding: '5rem 2rem 2rem' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '4rem' }}>
        ...
        {/* Brand & Integrity Focus */}
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            <GraduationCap color="#E5C100" size={32} />
            <h3 style={{ margin: 0, fontSize: '1.6rem', fontWeight: '800' }}>GradeAlign</h3>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#E5C100', fontSize: '0.85rem', fontWeight: '700' }}>
            <ShieldCheck size={18} /> Academic Integrity Focused
          </div>
        </div>

        {/* Who We Help - High Impact Audience Validation */}
        <div>
          <h4 style={{ marginBottom: '1.5rem', color: '#E5C100', textTransform: 'uppercase', letterSpacing: '0.1em', fontSize: '0.9rem' }}>Who We Help</h4>
        ...
        {/* Quick Links & Consolidated CTA */}
        <div>
          <h4 style={{ marginBottom: '1.5rem', color: '#E5C100', textTransform: 'uppercase', letterSpacing: '0.1em', fontSize: '0.9rem' }}>Quick Links</h4>
          <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
            ...
            <li><a href="#contact" style={{ ...linkStyle, color: '#E5C100', fontWeight: '800', display: 'flex', alignItems: 'center', gap: '5px' }}>
        ...
        {/* Contact Hubs */}
        <div>
          <h4 style={{ marginBottom: '1.5rem', color: '#E5C100', textTransform: 'uppercase', letterSpacing: '0.1em', fontSize: '0.9rem' }}>Contact Hubs</h4>
